...
const translations: Record<Language, Labels> = {
  es: {
    ...
    prop_host_description: "¡Hola! Soy tu anfitrión, ingeniero de profesión, deportista y amante de viajar. Hace poco decidí reformar y preparar mis alojamientos con mucho cariño para embarcarme en el mundo del alquiler turístico y ofrecer estancias de calidad. Soy una persona extrovertida, risueña y con sentido del humor. Estoy disponible para ayudarte a que tu estancia supere tus expectativas y sea lo más placentera posible. ¡Espero recibirte pronto!",
  ...
  de: {
    ...
    prop_host_description: "Hallo! Ich bin Ihr Gastgeber, von Beruf Ingenieur, Sportler und reiselustig. Ich habe vor kurzem beschlossen, meine Unterkünfte mit viel Liebe zu renovieren und vorzubereiten, um in die Welt der Ferienvermietung einzusteigen und Qualitätsaufenthalte anzubieten. Ich bin ein aufgeschlossener, fröhlicher Mensch mit Sinn für Humor. Ich stehe Ihnen zur Verfügung, um Ihnen zu helfen, dass Ihr Aufenthalt Ihre Erwartungen übertrifft und so angenehm wie möglich ist. Ich freue mich darauf, Sie bald begrüßen zu dürfen!",
