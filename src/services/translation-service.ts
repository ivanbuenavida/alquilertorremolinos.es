...
const translations: Record<Language, Labels> = {
  es: {
    ...
    cal_limit_reach_msg: (phone) => `No disponible para reservas a más de 5 meses vista por la web. Para estancias de larga duración o fechas lejanas, contacta directamente al ${phone}`,
...
export class TranslationService {
  ...
  static translateAmenity(key: string): string {
    const map: any = {
      ...
      'bi-grid-1x2': this.l.amen_microwave,
      'bi-moisture': this.l.amen_kettle,
      'bi-box-seam': this.l.amen_toaster,
      'bi-egg-fried': this.l.amen_essentials,
      'bi-wind': this.l.amen_hairdryer,
      'bi-magic': this.l.amen_toiletry,
      'bi-hammer': this.l.amen_iron,
